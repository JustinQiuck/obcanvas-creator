...
状态：已完成现有代码与官方 API 核对，形成 P0 实施设计；尚未引入源码、安装插件或完成运行验证。
...
P0-A 是下一块可实施的代码范围。P0 全部通过后，进入 [总计划](plan.md) 中 P1 的三个镜头、多候选和采用状态验收。不能将显示一个空画布称为已完成打通。
...
- 待验证：实际引入组件的构建、样式隔离、事件边界、双向保存、重开恢复、视频解码及外置素材访问。
- 本次交付只有代码核对与接入设计；原画布业务代码和 Obsidian 设置未修改。
