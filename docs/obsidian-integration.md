...
状态：P0-A／P0-B／P0-C 已在隔离 Obsidian 1.13.7 实例中通过验收。见 [笔记](validation/p0-a.md)、[画布](validation/p0-b.md)、[素材](validation/p0-c.md) 及 [源码复用记录](source-reuse.md)。
...
P0 已全部通过，后续进入 [总计划](plan.md) 中 P1 的三个镜头、多候选和采用状态验收。不能将显示一个空画布称为已完成打通。
